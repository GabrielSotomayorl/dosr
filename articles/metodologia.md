...
obs_media(
  design_2022,
  var             = "ytotcorh",
  filt            = pco1 == 1, # una observación por hogar
...
- Lumley, T. (2010). *Complex Surveys: A Guide to Analysis Using R*.
  Wiley.
- División Observatorio Social (2023). *Manual para la Investigación.
  Casen 2022*. Subsecretaría de Evaluación Social, Ministerio de
  Desarrollo Social y Familia.
  <https://bidat.gob.cl/details/ficha/dato/manual-para-la-investigacion-casen-2022>
- Instituto Nacional de Estadísticas (2020). *Fundamentos del Estándar
  para la evaluación de la calidad de las estimaciones en encuestas de
  hogares*. INE.
