...
multi_bin <- function(
  ...
  .calculate_estimates_multi <- function(d, vars, by = NULL) {
    ...
    # Pasada 2: totales para todas las variables (separado para evitar conflicto
    # de nombres: r8a como input vs r8a como output de survey_mean)
    ...
    # Una sola pasada no ponderada: n_mues por variable + gl
