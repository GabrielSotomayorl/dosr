...
[![CRAN
status](https://www.r-pkg.org/badges/version/dosr)](https://CRAN.R-project.org/package=dosr)
...
Herramientas de análisis de encuestas para el Observatorio Social del
...
área](reference/figures/excel-consolidado.png)
...
![Hoja de formato con series de tiempo y tests de
significancia](reference/figures/excel-formato.png)
...
Los resultados incluyen una columna `fiabilidad` que clasifica
automáticamente la calidad de cada estimación:
...
Los criterios se aplican en orden de prioridad (grados de libertad →
tamaño muestral → CV o EE). Todos los umbrales son configurables.
Consulta la [viñeta de
metodología](https://gabrielsotomayorl.github.io/dosr/articles/metodologia.html)
para los detalles estadísticos.
